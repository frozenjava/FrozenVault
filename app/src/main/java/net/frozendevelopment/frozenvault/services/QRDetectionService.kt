...
class QRDetectionService(private val onDetected: (List<FirebaseVisionBarcode>) -> Unit): ImageAnalysis.Analyzer {
    override fun analyze(image: ImageProxy?, rotationDegrees: Int) {
        ...
        detector.detectInImage(visionImage)
            ...
            .addOnFailureListener {
                Log.e("QrDetectionService", "something went wrong", it)
            }
    }
